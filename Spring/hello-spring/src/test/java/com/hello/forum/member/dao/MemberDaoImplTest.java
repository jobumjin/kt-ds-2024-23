...
public class MemberDaoImplTest {
	...
	public void getEmailCountTest() {
		...
		count = this.memberDao.getEmailCount("rkskek@rkskek.comf");
...
//		int insertedCount = this.memberDao.createNewMember(memberVO);
		DataIntegrityViolationException exception = 
				Assertions.assertThrows(DataIntegrityViolationException.class, () -> this.memberDao.createNewMember(memberVO));
	...
	public void createNewMemberFailDupEmailTest() {
		...
		MemberVO memberVO = new MemberVO();
		memberVO.setEmail("rkskek@rkskek.comf");
		memberVO.setName("junit테스트");
		memberVO.setPassword("testpassword for junit");
		memberVO.setSalt("asdfasdf");
		
		DuplicateKeyException exception = 
				Assertions.assertThrows(DuplicateKeyException.class, () -> this.memberDao.createNewMember(memberVO));
